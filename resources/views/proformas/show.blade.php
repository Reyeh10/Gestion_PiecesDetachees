...
@section('content')
        ...
        <div class="card shadow-sm">
            <div class="card-body p-5">
                        ...
                        <table class="no-border">
                            ...
                            <tr>
                                ...
                                <td style="padding:8px 0;text-align:right;color:red;">
                                    ...
                                    ({{ number_format(round($sale->discount), 0, ',', ' ') }}%)
               ...
               <form action="{ { route('proformas.payment', $sale) }}"
                    method="POST"
                ...
                <div class="text-end mt-5 print-hide">
                   ...
                   <a href="{{ route('proformas.pdf', ['proforma' => $sale->id]) }}"
                 ...
                 <form
                        action="{{ route('proformas.convert-sale', $sale->id) }}"
                        method="POST"
                        class="d-inline"
                     >
